...
public interface ShoppingCartSubsystem {
	/**
	 * Used during customer login -- when login succeeds, customer profile is set in
	 * shopping cart subsystem
	 */
	public void setCustomerProfile(CustomerProfile custProfile);

	/**
	 * Used during customer login to cache this customer's saved cart -- performs a
	 * database access through data access subsystem
	 */
