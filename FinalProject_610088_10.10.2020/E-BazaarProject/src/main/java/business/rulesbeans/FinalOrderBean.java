...
public class FinalOrderBean implements DynamicBean {
	private static final Logger LOG = Logger.getLogger(FinalOrderBean.class.getPackage().getName());
	...
	/**
	 * This is a collection of pairs indicating the quantity requested vs quantity
	 * avail for each line item in the shopping cart
	 * 
	...
	/**
	 * Find a way to implement this -- either implement getProductTable or do a
	 * different way
	 */
...
//    	return list;
		...
		while (it.hasNext()) {
			...
			reqAvailList.add(new Pair(Integer.parseInt(nextQuantRequested), nextQuantAvail));
