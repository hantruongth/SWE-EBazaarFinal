...
//	this is true if this cart item is data that has come from
	...
	public CartItemImpl(String productName, String quantity, String totalprice) throws BackendException {
	...
	public CartItemImpl(Integer cartid, Integer productid, Integer lineitemid, String quantity, String totalprice,
