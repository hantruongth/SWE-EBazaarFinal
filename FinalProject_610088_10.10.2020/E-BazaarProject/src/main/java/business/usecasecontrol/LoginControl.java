...
public class LoginControl {
	...
	public CustomerSubsystem prepareAndStoreCustomerObject(Login login, int authorizationLevel)
			throws BackendException {
		CustomerSubsystem customer = new CustomerSubsystemFacade();
		// need to place into SessionContext immediately since the facade will be used
		// during
