...
public class Authorization {
	...
	public static Map<Class<? extends Stage>, Boolean> acl = new HashMap<Class<? extends Stage>, Boolean>();
	...
	public static void checkAuthorization(Stage c, boolean custIsAdmin) throws UnauthorizedException {
