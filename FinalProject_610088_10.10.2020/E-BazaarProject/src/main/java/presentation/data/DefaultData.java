...
public class DefaultData {
	...
	public static final Product MESSIAH_BOOK = ProductSubsystemFacade.createProduct(BOOKS_CATALOG, "Messiah Of Dune",
			LocalDate.of(2000, 11, 11), 20, 15.00);
	public static final Product GONE_BOOK = ProductSubsystemFacade.createProduct(BOOKS_CATALOG, "Gone with the Wind",
			LocalDate.of(1995, 12, 5), 15, 12.00);
	public static final Product GARDEN_BOOK = ProductSubsystemFacade.createProduct(BOOKS_CATALOG, "Garden of Rama",
			LocalDate.of(2005, 1, 1), 5, 18.00);
	public static final Product PANTS = ProductSubsystemFacade.createProduct(CLOTHES_CATALOG, "Pants",
			LocalDate.of(2000, 11, 1), 20, 15.00);
	public static final Product SKIRTS = ProductSubsystemFacade.createProduct(CLOTHES_CATALOG, "Skirts",
			LocalDate.of(1995, 1, 5), 15, 12.00);
	public static final Product TSHIRTS = ProductSubsystemFacade.createProduct(CLOTHES_CATALOG, "T-Shirts",
			LocalDate.of(2003, 6, 18), 10, 22.00);
	...
	public final static ObservableMap<CatalogPres, List<ProductPres>> PRODUCT_LIST_DATA = FXCollections
			.observableHashMap();

	public static final List<String> DEFAULT_SHIP_DATA = Arrays.asList("101 Adams St.", "Fairfield", "IA", "52556");
	public static final List<String> DEFAULT_BILLING_DATA = Arrays.asList("21 Berkeley Ave.", "Cincinnati", "OH",
			"45201");
	public static final List<String> DEFAULT_PAYMENT_INFO = Arrays.asList("John Thomas", "5555444466669999", "Visa",
			"11/11/2017");
	// "Name", "Card Number", "Card Type", "Expiration Date"
	public static final List<Address> ADDRESSES_ON_FILE = Arrays.asList(
			CustomerSubsystemFacade.createAddress("101 Jackson St", "Fairfield", "IA", "52556", true, true),
	...
	public static final List<CustomerPres> CUSTS_ON_FILE = Arrays.asList(
			new CustomerPres(CustomerSubsystemFacade.createCustProfile(1, "John", "Smith", false)),
	...
	public static final OrderItemImpl orderItem1 = new OrderItemImpl(MESSIAH_BOOK.getProductName(), 2,
			MESSIAH_BOOK.getUnitPrice());
	public static final OrderItemImpl orderItem2 = new OrderItemImpl(GARDEN_BOOK.getProductName(), 3,
			GARDEN_BOOK.getUnitPrice());
	public static final OrderItemImpl orderItem3 = new OrderItemImpl(PANTS.getProductName(), 2, PANTS.getUnitPrice());
	public static final OrderItemImpl orderItem4 = new OrderItemImpl(SKIRTS.getProductName(), 1, SKIRTS.getUnitPrice());
	...
	static {
		...
		// savedItem2.setTotalPrice(GuiUtils.stringDoublesMultiply(savedItem2.getQuantity(),
		// savedItem2.getPrice()));

		PRODUCT_LIST_DATA.put(BOOKS_CAT_PRES, new ArrayList<ProductPres>() {
			{
		...
		PRODUCT_LIST_DATA.put(CLOTHES_CAT_PRES, new ArrayList<ProductPres>() {
			{
				add(PANTS_PRES);
				add(SKIRTS_PRES);
				add(TSHIRTS_PRES);
