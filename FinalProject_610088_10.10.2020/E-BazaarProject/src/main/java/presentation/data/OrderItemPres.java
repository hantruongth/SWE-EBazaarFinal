...
public class OrderItemPres {
	...
	public SimpleStringProperty itemIdProperty() {
		return new SimpleStringProperty((new Integer(orderItem.getOrderItemId())).toString());
	}

	public SimpleStringProperty orderIdProperty() {
		return new SimpleStringProperty((new Integer(orderItem.getOrderId())).toString());
	}

	public SimpleStringProperty quantityProperty() {
		return new SimpleStringProperty((new Integer(orderItem.getQuantity())).toString());
	}

	public SimpleStringProperty unitPriceProperty() {
		return new SimpleStringProperty((new Double(orderItem.getUnitPrice())).toString());
	}

	public SimpleStringProperty totalPriceProperty() {
		return new SimpleStringProperty(String.format("%.2f", (new Double(orderItem.getTotalPrice()))));
	}
	...
	/*
	 * private int itemID; private int orderID; private final String productName;
	 * private final int quantity; private final double unitPrice;
	 */
