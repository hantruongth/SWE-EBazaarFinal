...
public class CatalogListWindow extends Stage implements MessageableWindow, ModifiableTableWindow {
	// These lines of code make CatalogListWindow a singleton -- singleton
	// implementation
	...
	public void setStage(Stage ps) {
		...
		// set up table
		TableColumn<CatalogPres, String> catalogNameCol = TableUtil.makeTableColumn(new CatalogPres(), "Catalog",
