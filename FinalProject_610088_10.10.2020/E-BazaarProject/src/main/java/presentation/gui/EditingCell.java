...
/**
 *
 * This class supports cell editing with these features: 1. When user hits
 * Enter, editing completes 2. When user clicks away from cell being edited,
 * editing completes 3. When user clicks button for next action, editing
 * completes
 */
