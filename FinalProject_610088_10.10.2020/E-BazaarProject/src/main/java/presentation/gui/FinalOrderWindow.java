...
public class FinalOrderWindow extends Stage implements DefaultShoppingCartWindow {
	...
	public HBox setUpButtons() {
		...
		shopCartButton.setOnAction(CheckoutUIControl.INSTANCE.getToShoppingCartFromFinalOrderHandler());
		return btnBox;
	}
}
