...
public class FiveByTwoGridPane extends GridPane {
	...
	public FiveByTwoGridPane(List<String> rowHeaders, List<String> values, String borderColor, int minWidth) {
	...
	public FiveByTwoGridPane(List<String> rowHeaders, TextField[] fieldValues, String borderColor, int minWidth) {
		this.rowHeaders = rowHeaders;
