...
public class FourByTwoGridPane extends GridPane {
	...
	public FourByTwoGridPane(List<String> rowHeaders, List<String> values, String borderColor, int minWidth) {
	...
	public FourByTwoGridPane(List<String> rowHeaders, TextField[] fieldValues, String borderColor, int minWidth) {
		this.rowHeaders = rowHeaders;
	...
	public FourByTwoGridPane(List<String> rowHeaders, List<? extends Node> nodeValues, String borderColor,
			double minWidth) {
		this.rowHeaders = rowHeaders;
