...
public class OrderDetailWindow extends Stage {
	...
	public OrderDetailWindow() {
		...
		// set up table
		TableColumn<OrderItemPres, String> productNameCol = TableUtil.makeTableColumn(new OrderItemPres(),
				"Product Name", "productNameProperty", 100);
		TableColumn<OrderItemPres, String> quantityCol = TableUtil.makeTableColumn(new OrderItemPres(), "Quantity",
				"quantityProperty", 100);
		TableColumn<OrderItemPres, String> unitPriceCol = TableUtil.makeTableColumn(new OrderItemPres(), "Unit Price",
				"unitPriceProperty", 100);
		TableColumn<OrderItemPres, String> totalPriceCol = TableUtil.makeTableColumn(new OrderItemPres(), "Total Price",
	...
	private HBox setUpButtons() {
		...
		okButton.setOnAction(ViewOrdersUIControl.INSTANCE.getOrderDetailsOkHandler());
		return btnBox;
	}
