...
public class ProductListWindow extends Stage implements MessageableWindow {
	...
	public ProductListWindow(CatalogPres catalog) {
		...
		// set up table
		TableColumn<ProductPres, String> productNameCol = TableUtil.makeTableColumn(new ProductPres(),
				String.format(catalog.nameProperty().get()), "nameProperty", GuiConstants.GRID_PANE_WIDTH);
